...
import cn.xxstudy.quickflutter.check.AssetsChecker;
import cn.xxstudy.quickflutter.check.ICheck;
import cn.xxstudy.quickflutter.check.ProjChecker;
...
//    }
    ...
    private List<String> getAssets(String path) {
        Utils.writeLog("Scanning asset files under asset, assets and images...");
        assetsNames.clear();
        namedAssets.clear();
    ...
    private void updatePubspec(String path, List<String> assets) {
        Utils.writeLog("Updating pubspec.yaml...");
    ...
    private void genResDart(String path, List<String> assets) {
        Utils.writeLog("Updating res.dart...");
        ...
        Utils.writeLog("Flutter assets reference has been updated.");
        showSuccessInfo();
    }
